 ...
 * @param {number} overlap - Number of words to overlap between chuncks
    ...
    if (paragraphWordCount > chunkSize) {
      if (currentChunk.length > 0) {
        chunks.push({
          ...
          pageNumber: 0, // Placeholder - replace with actual page number if available
        });
        currentChunk = [];
        currentWordCount = 0;
      }
 ...
 * @returns {Array<Object>} - The relevant chunks
 */
