            ...
            <form onSubmit={handleGenerateQuiz} className='space-y-4'>
                <div className="mb-4">
                    ...
                    <input
                        ...
                        min={1}
                        className="w-full h-9 border border-neutral-200 rounded-lg px-3 bg-white text-sm text-neutral-900 placeholder-neutral-400 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[#00d492] focus:border-transparent"
                    />
                </div>
