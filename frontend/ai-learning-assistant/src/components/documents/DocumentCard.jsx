    ...
    <div className='group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-5 hover:border-slate-300/60 hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1' onClick={handleNavigate}>
        ...
        <div>
            <div className="flex items-start justify-between gap-3 mb-4">
                <div className="shrink-0 size-12 bg-linear-to-br from-emerald-500 to-cyan-500 rounded-xl flex justify-center items-center shadow-lg shadow-blue-500/25 group-hover:scale-110 transition-transform duration-300">
                    <FileText className='size-6 text-white' strokeWidth={2} />
                </div>
                <button onClick={handleDelete} className='opacity-0 group-hover:opacity-100 size-8 flex items-center justify-center text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all duration-200'>
            ...
            <div className="flex items-center gap-3">
                {document.flashcardCount !== undefined && (
                    <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-purple-50 rounded-lg">
                        <BookOpen className='size-3.5 text-purple-600' strokeWidth={2} />
                ...
                {document.quizCount !== undefined && (
                    <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-emerald-50 rounded-lg">
                        <BrainCircuit className='size-3.5 text-emerald-600' strokeWidth={2} />
        ...
        {/* Footer Section */}
        <div className="mt-5 pt-4 border-t border-t-slate-100">
