...
const FlashcardPage = () => {
  ...
  const handleReview = async (index) =>{
    ...
    try {
      ...
      toast.error('Error reviewing flashcard');
    }
  }
  ...
  const handleToggleStar = async (cardId) => {
    try {
      ...
      toast.success('Flashcard star status updated successfully');
      fetchFlashcards();
    } catch (error) {
      toast.error('Error updating flashcard star status');
    }
  }
    ...
    if (flashcards.length === 0) {
      return (
        <EmptyState
          ...
          description="Generate some flashcards to get started."
        />
      )
    }
