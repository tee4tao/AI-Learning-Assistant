        ...
        <div className="relative max-w-7xl mx-auto">
            ...
            {stat.map((stat, index) => (
              <div key={index} className='group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-300 hover:-translate-y-1'>
                <div className="flex items-center justify-between">
                  ...
                  <div className={`size-11 rounded-xl bg-linear-to-br ${stat.gradient} shadow-lg ${stat.shadowColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                    <stat.icon className='size-5 text-white' strokeWidth={2} />
                  </div>
                </div>
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="size-10 rounded-xl bg-linear-to-br from-slate-100 to-slate-200 flex items-center justify-center">
                <Clock className='size-5 text-slate-600' strokeWidth={2} />
              </div>
