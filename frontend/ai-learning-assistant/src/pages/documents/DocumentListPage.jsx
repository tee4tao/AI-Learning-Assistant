...
const DocumentListPage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {isUploadModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="relative w-full bg-white/95 backdrop-blur-xl border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            {/* close button */}
            <button onClick={() => setIsUploadModalOpen(false)} className="absolute top-6 right-6 size-8 flex items-center justify-center rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-all duration-200">
            ...
            <div className="space-y-2">
              ...
              <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200">
                ...
                <div className="flex flex-col items-center justify-center py-10 px-6">
                  <div className="size-14 rounded-xl bg-linear-to-r from-emerald-100 to-teal-100 flex items-center justify-center mb-4">
                    <Upload
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="relative w-full max-w-md backdrop-blur-xl border-slate-200/60 bg-white/95 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            {/* close button */}
            <button onClick={()=> setIsDeleteModalOpen(false)} className="absolute top-6 right-6 w-8 items-center justify-center rounded-xl text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-all duration-200">
              <X className="size-5" strokeWidth={2} />
            </button>

          {/* Modal Header */}
          <div className="mb-6">
            <div className="size-12 rounded-xl bg-linear-to-r from-red-100 to-red-200 flex items-center justify-center mb-4">
              <Trash2
